...
neg$label <- ifelse(neg$Compound %in% c("Asiaticoside(1)","4-O-Caffeoylshikimic acid(3)","4-O-Caffeoylshikimic acid(1)", "Puerarin xyloside(1)","Soyasaponin I(1)","Pseudopurpurin","6''-O-Acetylgenistin","Enicoflavine","Larixinic Acid","1-O-Feruloyl-beta-D-glucose"), neg$Compound, NA)
